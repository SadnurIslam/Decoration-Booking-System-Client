...
const AdminMenu = () => (
  <>
    ...
    <AnimatedItem to="/dashboard/manage-bookings" icon={<FaClipboardList />}>
      Manage Bookings
    </AnimatedItem>

    <AnimatedItem to="/dashboard/manage-decorators" icon={<FaUsers />}>
      Manage Decorators
    </AnimatedItem>
...
const DecoratorMenu = () => (
  <>
    <AnimatedItem to="/dashboard/assigned-projects" icon={<FaClipboardList />}>
      My Assigned Projects
    </AnimatedItem>

    <AnimatedItem to="/dashboard/schedule" icon={<FaCalendarAlt />}>
      Today's Schedule
    </AnimatedItem>
